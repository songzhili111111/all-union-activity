...
<script type="text/javascript">
	...
	function lottery() {
		...
		if(num == 0){
		  ...
		  var data = {'code':'code','version':'version','data':[{'themeId':'12345678900'
			  ,'choiceName':'987654321','choiceValue':'dfddf'
			  ,'choiceType':'12','imageUrl':'http://song.zili.xcom/song.jpg','imageName':'songzhili'}]};
				$.ajax({
					type : 'POST',
					url : 'voteThemeChoice/create',
					dataType : 'json',
