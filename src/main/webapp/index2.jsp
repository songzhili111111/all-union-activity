...
<script type="text/javascript" src="files/comm.js"></script>
<script type="text/javascript">
	...
	function lottery() {
		...
		var url = "http://192.168.15.102:8680/all-union-activity/fortuneWheel/controll";
		jQuery.axjsonpPost(url, data, call_back);
	};
   function call_back(json){
			var number = parseInt(json.remainNumber);	//剩余次数
			if(number == 0){
			...
			var msg = json.awardExplain; //提示信息
