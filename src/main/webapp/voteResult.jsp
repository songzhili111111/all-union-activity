...
<script type="text/javascript">
	...
	function lottery() {
		...
		if(num == 0){
		  ...
		  var data ={'code':'code','version':'version','data':[{'openId':'12345678900'
			  ,'appId':'987654321','choiceId':'ff80818155ddce900155e307c9690012'
			  ,'themeId':'ff80818155ddce900155e307c9690012'}]};
				$.ajax({
					type : 'POST',
					url : 'voteResultRecord/create',
					dataType : 'json',
