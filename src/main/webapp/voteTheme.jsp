...
<script type="text/javascript">
	...
	function lottery() {
		...
		if(num == 0){
		  ...
		  var data = [{'themeName':'test','numberLimit':'numberLimit','singleOrMulti':'0','startTime':'20160705103623',
		       		 'endTime':'20160705103623'},{'themeName':'test10','numberLimit':'numberLimit','singleOrMulti':'1','startTime':'20160705103623',
			       		 'endTime':'20160705103623'}];
				$.ajax({
					type : 'POST',
					url : 'voteTheme/create',
					dataType : 'json',
