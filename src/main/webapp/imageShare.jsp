	...
	function lottery() {
		...
		if(num == 0){
		 ...
		 var data ={'code':'code','version':'version','data':[{
                          'shareId':'ff808181567778f10156777b606b0001',
			  'shareName':'shareName','qrCode':'qrCode','qrCodeExplain':'qrCodeExplain'
			  ,'expandParamTwo':'expandParamTwo'
			  ,'shareExplain':[{'start':'1','end':'10','chance':'0.5'},
			   {'start':'6','end':'10','chance':'0.3'},{'start':'11','end':'15','chance':'0.1'}]
		      ,'expandParamOne':'expandParamOne','curragePage':'1','pageSize':'10'
		  }]};
				$.ajax({
					type : 'POST',
					url : 'imageShare/list',
